...
### Modded or not
There is an prompt if the user wants to get an modded version of the game or not. This will come at a later stage of the project.

## Auto start
Ask the user if an selected version of the Minecraft version should automaticly start on system bootup. This will come at a later stage of the project.
